...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cheatscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cheatscoin-tx [options] <hex-tx> [commands]  Update hex-encoded cheatscoin transaction\n" +
            "or:     cheatscoin-tx [options] -create [commands]   Create hex-encoded cheatscoin transaction\n" +
            "\n";
