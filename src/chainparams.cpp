...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting djchefoshis";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585996288, 38344, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x311543cbd4369f93d1e3581c28463a2005fe7b838c859e6e255be1e921d6c7bd"));
        assert(genesis.hashMerkleRoot == uint256S("0x9fd203a6d72392c2ea612a5f5f9b81187385dfc5d85a065cf63deeda37a290b3"));
        ...
        vSeeds.emplace_back("seed-a.cheatscoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.cheatscointools.com");
        vSeeds.emplace_back("dnsseed.cheatscoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 832992, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x18d944b07ca94722d7f2c42a9d842de0f296cfb87743a8e347acad379e555842"));
        assert(genesis.hashMerkleRoot == uint256S("0x9fd203a6d72392c2ea612a5f5f9b81187385dfc5d85a065cf63deeda37a290b3"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.cheatscointools.com");
        vSeeds.emplace_back("seed-b.cheatscoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf9e78f539f9f361d11791da491692a360ced1062174ac9a44db4661cd2274931"));
        assert(genesis.hashMerkleRoot == uint256S("0x9fd203a6d72392c2ea612a5f5f9b81187385dfc5d85a065cf63deeda37a290b3"));
