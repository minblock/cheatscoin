...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Cheatscoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Cheatscoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/cheatscoin-project/cheatscoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cheatscoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cheatscoin Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cheatscoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://cheatscoin.org/"
