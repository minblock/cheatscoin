# Support for Output Descriptors in Cheatscoin Core

Since Cheatscoin Core v0.17, there is support for Output Descriptors. This is a
...
on Cheatscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cheatscoin Core wallets, a convenience function `combo` is
