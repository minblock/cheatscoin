...
"""Verify that starting cheatscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cheatscoin with -h for help text")
        ...
        self.log.info("Start cheatscoin with -version for version information")
        ...
        self.log.info("Start cheatscoind with -fakearg to make sure it does not start")
