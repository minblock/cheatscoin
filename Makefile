...
pkgdatadir = $(datadir)/cheatscoin
pkgincludedir = $(includedir)/cheatscoin
pkglibdir = $(libdir)/cheatscoin
pkglibexecdir = $(libexecdir)/cheatscoin
...
ACLOCAL = ${SHELL} /cheatscoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /cheatscoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /cheatscoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /cheatscoin/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = cheatscoin-cli
BITCOIN_DAEMON_NAME = cheatscoind
BITCOIN_GUI_NAME = cheatscoin-qt
BITCOIN_TX_NAME = cheatscoin-tx
BITCOIN_WALLET_TOOL_NAME = cheatscoin-wallet
...
COPYRIGHT_HOLDERS_FINAL = The Cheatscoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Cheatscoin Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /cheatscoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = cheatscoin
PACKAGE_BUGREPORT = https://github.com/cheatscoin-project/cheatscoin/issues
PACKAGE_NAME = Cheatscoin Core
PACKAGE_STRING = Cheatscoin Core 0.18.1
PACKAGE_TARNAME = cheatscoin
PACKAGE_URL = https://cheatscoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /cheatscoin
abs_srcdir = /cheatscoin
abs_top_builddir = /cheatscoin
abs_top_srcdir = /cheatscoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /cheatscoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Cheatscoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/Cheatscoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Cheatscoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Cheatscoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
